          ...
          r > se
            ? this.slideTriggers.forEach((e) => {
                ...
                ;((t.progressBarSlide = document.createElement(`div`)),
                  ...
                  (t.scrollTriggerElements = t.scrollTriggers.map((n, r) => {
      ...
      setProgressBarValue(e) {
        this.progressBar &&
          ...
          this.getAllPages()
            ...
            .forEach((e) => {
              ;(e.progressBarSlide.classList.toggle(`active`, e.active === !0),
                e.scrollTriggers.forEach((t, n) => {
            ...
            t.style.display !== `none` &&
              (f.center || t.classList.contains(`center`)
                ? t.classList.contains(`stack`)
                  ? (t.style.top = 0)
                  : (t.style.top = Math.max((n.height - t.scrollHeight) / 2, 0) + `px`)
                : (t.style.top = ``))
          }
